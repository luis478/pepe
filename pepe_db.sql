...
CREATE  TABLE IF NOT EXISTS `pepe_db`.`usuario` (
  ...
  INDEX `fk_usuario_tipo_instructor1_idx` (`id_tipo_instructor` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `pepe_db`.`evento` (
  ...
  INDEX `fk_evento_actividad_aprendizaje_has_resultado_aprendizaje1_idx` (`id_actividad_aprendizaje` ASC, `id_resultado_aprendizaje` ASC) ,
  ...
  CONSTRAINT `fk_Evento_Ficha1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_evento_actividad_aprendizaje_has_resultado_aprendizaje1`
    FOREIGN KEY (`id_actividad_aprendizaje` , `id_resultado_aprendizaje` )
    REFERENCES `pepe_db`.`actividad_aprendizaje_has_resultado_aprendizaje` (`id_actividad_aprendizaje` , `id_resultado_aprendizaje` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `pepe_db`.`usuario_has_acompanamiento` (
  ...
  `acompanamiento_id_acompanamiento` INT NOT NULL ,
  PRIMARY KEY (`usuario_id_usuario`, `acompanamiento_id_acompanamiento`) ,
  INDEX `fk_usuario_has_acompanamiento_acompanamiento1_idx` (`acompanamiento_id_acompanamiento` ASC) ,
  INDEX `fk_usuario_has_acompanamiento_usuario1_idx` (`usuario_id_usuario` ASC) ,
  ...
  CONSTRAINT `fk_usuario_has_acompanamiento_acompanamiento1`
    FOREIGN KEY (`acompanamiento_id_acompanamiento` )
    REFERENCES `pepe_db`.`acompanamiento` (`id_acompanamiento` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `pepe_db`.`aspectos` (
  ...
  PRIMARY KEY (`id_aspectos`, `ficha_id_ficha`) ,
  INDEX `fk_aspectos_ficha1_idx` (`ficha_id_ficha` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `pepe_db`.`usuario_has_aspectos` (
  `usuario_id_usuario` INT NOT NULL ,
  `aspectos_id_aspectos` INT NOT NULL ,
  `aspectos_ficha_id_ficha` INT NOT NULL ,
  PRIMARY KEY (`usuario_id_usuario`, `aspectos_id_aspectos`, `aspectos_ficha_id_ficha`) ,
  INDEX `fk_usuario_has_aspectos_aspectos1_idx` (`aspectos_id_aspectos` ASC, `aspectos_ficha_id_ficha` ASC) ,
  INDEX `fk_usuario_has_aspectos_usuario1_idx` (`usuario_id_usuario` ASC) ,
  ...
  CONSTRAINT `fk_usuario_has_aspectos_aspectos1`
    FOREIGN KEY (`aspectos_id_aspectos` , `aspectos_ficha_id_ficha` )
    REFERENCES `pepe_db`.`aspectos` (`id_aspectos` , `ficha_id_ficha` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`caracterizacion` (`id_caracterizacion`, `acudiente`, `telefono`, `direccion`, `sistema_lidereazgo`, `apoyo_bienestar`) VALUES (1, 'gloria', '1234', 'calle 24#12-23', ' ninguno', 'ninguno');
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`patrocinio` (`id_patrocinio`, `id_empresa`, `patrocinio`) VALUES (1, 1, 'itkfmf');
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`estado` (`id_estado`, `estado`) VALUES (1, 'ninguno');
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`eps` (`id_eps`, `nombre_eps`) VALUES ('1', 'sos');
