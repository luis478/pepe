...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`actividad_aprendizaje` (`id_actividad_aprendizaje`, `nombre_actividad_aprendizaje`, `duracion_actividad_aprendizaje`, `observaciones`, `id_tipo_actividad_aprendizaje`, `id_actividad`) VALUES (1, 'identificar los componentes de hardware y software de un computador', 10, 'ninguna', 2, 1);
