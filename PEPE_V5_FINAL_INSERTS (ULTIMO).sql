...
CREATE TABLE IF NOT EXISTS `pepe_db`.`resultado_aprendizaje` (
  ...
  INDEX `fk_resultado_aprendizaje_usuario1_idx` (`id_usuario` ASC),
  ...
  CONSTRAINT `fk_Resultado_Aprendizaje_Competencia1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_resultado_aprendizaje_usuario1`
    FOREIGN KEY (`id_usuario`)
    REFERENCES `pepe_db`.`usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `pepe_db`.`proyecto` (
  ...
  `innovacion_2_6_1` TINYINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pepe_db`.`actividad_has_resultado_aprendizaje` (
  ...
  INDEX `fk_actividad_has_resultado_aprendizaje_fase1_idx` (`id_fase` ASC),
  ...
  CONSTRAINT `fk_Actividad_has_Resultado_Aprendizaje_Resultado_Aprendizaje1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_actividad_has_resultado_aprendizaje_fase1`
    FOREIGN KEY (`id_fase`)
    REFERENCES `pepe_db`.`fase` (`id_fase`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `pepe_db`.`evento_has_resultado_aprendizaje`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pepe_db`.`evento_has_resultado_aprendizaje` (
  `id_evento` INT NOT NULL,
  `id_resultado_aprendizaje` INT NOT NULL,
  PRIMARY KEY (`id_evento`, `id_resultado_aprendizaje`),
  INDEX `fk_evento_has_resultado_aprendizaje_resultado_aprendizaje1_idx` (`id_resultado_aprendizaje` ASC),
  INDEX `fk_evento_has_resultado_aprendizaje_evento1_idx` (`id_evento` ASC),
  CONSTRAINT `fk_evento_has_resultado_aprendizaje_evento1`
    FOREIGN KEY (`id_evento`)
    REFERENCES `pepe_db`.`evento` (`id_evento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_evento_has_resultado_aprendizaje_resultado_aprendizaje1`
    FOREIGN KEY (`id_resultado_aprendizaje`)
    REFERENCES `pepe_db`.`resultado_aprendizaje` (`id_resultado_aprendizaje`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`resultado_aprendizaje` (`id_resultado_aprendizaje`, `id_tipo_resultado_aprendizaje`, `id_competencia`, `nombre_resultado_aprendizaje`, `estado`, `id_usuario`) VALUES (1, 1, 1, 'xxxxx', 1, 1);
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`actividad` (`id_actividad`, `nombre_actividad`, `duracion`, `id_proyecto`) VALUES (1, 'induccion', 40, 2222);
INSERT INTO `pepe_db`.`actividad` (`id_actividad`, `nombre_actividad`, `duracion`, `id_proyecto`) VALUES (2, 'on respecto a los resultados', 121, 2223);
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`actividad_has_resultado_aprendizaje` (`id_actividad`, `id_resultado_aprendizaje`, `id_fase`) VALUES (1, 1, 1);
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`evento` (`id_evento`, `fecha_inicio`, `fecha_fin`, `id_ambiente_formacion`, `id_ficha`) VALUES (1, '2012-12-12 12:12:00', '2014-01-01 12:00:00', 1, 1);

COMMIT;


-- -----------------------------------------------------
-- Data for table `pepe_db`.`evento_has_usuario`
-- -----------------------------------------------------
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`evento_has_usuario` (`id_evento`, `id_usuario`) VALUES (1, 1);

COMMIT;


-- -----------------------------------------------------
-- Data for table `pepe_db`.`evento_has_trimestre`
-- -----------------------------------------------------
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`evento_has_trimestre` (`id_evento`, `id_trimestre`) VALUES (1, 1);
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`criterio_seguimiento_has_acompanamiento` (`id_criterio_seguimiento`, `id_acompanamiento`, `valoracion`, `id_conclusiones`, `observacion`) VALUES (1, 1, 'xxxx', 1, 'xxxxx');
...
-- -----------------------------------------------------
-- Data for table `pepe_db`.`evento_has_resultado_aprendizaje`
-- -----------------------------------------------------
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`evento_has_resultado_aprendizaje` (`id_evento`, `id_resultado_aprendizaje`) VALUES (1, 1);
