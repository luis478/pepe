...
CREATE  TABLE IF NOT EXISTS `pepe_db`.`variable` (
  ...
  INDEX `fk_variable_tipo_revision1_idx` (`id_tipo_revision` ASC) ,
  CONSTRAINT `fk_variable_tipo_revision1`
    FOREIGN KEY (`id_tipo_revision` )
    REFERENCES `pepe_db`.`tipo_revision` (`id_tipo_revision` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (1, 'La información básica  del proyecto está completamente diligenciada	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (2, 'El nombre del proyecto está relacionado con el programa de formación y los problemas identificados en el entorno.	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (3, 'El tiempo de duración del proyecto se determina  teniendo como referencia la duración del programa de formación .	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (4, 'El  problema es formulado a partir del perfil de salida del aprendiz (nivel del programa de formación.)	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (5, 'El  problema es formulado a partir de una necesidad u oportunidad del entorno.	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (6, 'La justificación del proyecto permite identificar los aportes que ofrece su ejecución frente a necesidades y oportunidades identificadas, indicando las diferencias con otras soluciones existentes (según el caso).	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (7, 'El Objetivo General del proyecto es medible, verificable y  refleja el propósito o intencionalidad del proyecto.	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (8, 'Los objetivos específicos son medibles, verificables y conducen al logro del objetivo general.	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (9, 'Los objetivos específicos se estructuran para la consecución de los productos o resultados del proyecto.	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (10, 'El alcance identifica la población  beneficiada de los productos o resultados del proyecto.	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (11, 'El alcance del proyecto permite identificar los impactos (social, económico, ambiental, tecnológico) en que se ven beneficiados los usuarios.	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (12, 'Las restricciones o riesgos asociados permiten identificar los factores internos y externos que pueden afectar el normal desarrollo del proyecto y plantea las alternativas de solución pertinentes.	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (13, 'El (los) producto (s) del proyecto responden al desarrollo de las actividades y resultados del proyecto (solución del problema).	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (14, 'Las actividades del proyecto están relacionadas con los resultados de aprendizaje del programa de formación. 	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (15, 'En el desarrollo de las actividades del  proyecto se consideran las condiciones medioambientales y de seguridad industrial.	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (16, 'En el desarrollo del proyecto se evidencian aspectos de innovación o gestión tecnológica.	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (17, 'El proyecto describe  los ambientes de aprendizaje necesarios para su ejecución	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (18, 'El proyecto describe  los  elementos y condiciones de seguridad industrial, salud ocupacional y medio ambiente  necesarios para su ejecución	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (19, 'El proyecto relaciona los materiales de formación consumibles y devolutivos (maquinaria y equipos) necesarios para su ejecución	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (20, 'El proyecto relaciona el perfil y el talento humano requerido	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (21, 'El proyecto tiene definidos el presupuesto para la ejecución del proyecto.	', 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (22, 'Los ambientes  asignados responden a  los requerimientos establecidos para el programa de formación.		', 2);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (23, 'Reúne las condiciones ambientales (iluminación, temperatura, ventilación, aseo, ruido)  requeridas para el desarrollo del programa de formación.		', 2);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (24, 'Reúne las condiciones de seguridad industrial (señalización, demarcación, rutas de seguridad, etc.) requeridas para el desarrollo del programa de formación.		', 2);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (25, 'Se cuenta con permisos o licencias requeridas para el funcionamiento de espacios, equipos o software durante el período de ejecución del programa de formación.		', 2);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (26, 'Los equipos, máquinas y mobiliario son suficientes y están distribuidos en el espacio según exigencias del programa de formación y número de aprendices.		', 2);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (27, 'Las condiciones técnicas de la maquinaria y equipos es la requerida para el cumplimiento del programa de formación.		', 2);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (28, 'Cuenta con los materiales e insumos requeridos para desarrollar el programa de formación de acuerdo con el diseño curricular.		', 2);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (29, 'El perfil de los instructores disponibles corresponde con el perfil definido para cada competencia del programa de formación.		', 2);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `nombre_variable`, `id_tipo_revision`) VALUES (30, 'Se cuenta con biblioteca y con la bibliografía básica (Física y/o digital), según lo establecido en el diseño del programa de formación.		', 2);
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`valoracion` (`id_valoracion`, `cumple`, `observacion`, `id_revision`, `id_variable`, `id_variable_ambiente`) VALUES (1, 1, 'ninguna', 1, 1, 1);
INSERT INTO `pepe_db`.`valoracion` (`id_valoracion`, `cumple`, `observacion`, `id_revision`, `id_variable`, `id_variable_ambiente`) VALUES (2, 0, 'ninguna', 2, 2, 2);
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`seguimiento` (`id_seguimiento`, `observaciones`, `id_fase`, `id_ficha`, `id_usuario`, `fecha_registro`) VALUES (1, '', 1, 1, 1, '2015-01-01 00:00:00');
INSERT INTO `pepe_db`.`seguimiento` (`id_seguimiento`, `observaciones`, `id_fase`, `id_ficha`, `id_usuario`, `fecha_registro`) VALUES (2, '', 1, 1, 1, '2015-01-01 00:00:00');
