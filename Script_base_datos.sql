...
CREATE TABLE IF NOT EXISTS `pepe_db`.`programador` (
  ...
  INDEX `fk_programador_ficha1_idx` (`id_ficha` ASC),
  ...
  CONSTRAINT `fk_programador_usuario1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_programador_ficha1`
    FOREIGN KEY (`id_ficha`)
    REFERENCES `pepe_db`.`ficha` (`id_ficha`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `pepe_db`.`item_criterio` (
  ...
  `valoracion_item` VARCHAR(20) NOT NULL,
  `observacion` TEXT NULL,
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`programador` (`id_programador`, `cantidad_hora`, `id_actividad`, `id_resultado_aprendizaje`, `id_usuario`, `trimestre`, `id_ficha`) VALUES (1, 4, 1, 1, 1, 1, 1);
INSERT INTO `pepe_db`.`programador` (`id_programador`, `cantidad_hora`, `id_actividad`, `id_resultado_aprendizaje`, `id_usuario`, `trimestre`, `id_ficha`) VALUES (2, 2, 1, 1, 1, 1, 2);
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`seguimiento` (`id_seguimiento`, `observaciones`, `id_fase`, `id_ficha`, `id_usuario`, `fecha_registro`) VALUES (1, '', 1, 1, 1, DEFAULT);
INSERT INTO `pepe_db`.`seguimiento` (`id_seguimiento`, `observaciones`, `id_fase`, `id_ficha`, `id_usuario`, `fecha_registro`) VALUES (2, '', 1, 1, 1, DEFAULT);
