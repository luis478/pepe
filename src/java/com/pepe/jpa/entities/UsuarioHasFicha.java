...
@NamedQueries({
    ...
    @NamedQuery(name = "UsuarioHasFicha.findByIdTipoInstructor", query = "SELECT u FROM UsuarioHasFicha u WHERE u.usuarioHasFichaPK.idTipoInstructor = :idTipoInstructor")})
public class UsuarioHasFicha implements Serializable {
    ...
    @ManyToOne(optional = false)
    private Ficha ficha;
    @JoinColumn(name = "id_tipo_instructor", referencedColumnName = "id_tipo_instructor", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    ...
    public UsuarioHasFicha(int idUsuario, int idFicha, int idTipoInstructor) {
        this.usuarioHasFichaPK = new UsuarioHasFichaPK(idUsuario, idFicha, idTipoInstructor);
    }
    ...
    public TipoInstructor getTipoInstructor() {
        return tipoInstructor;
    }

    public void setTipoInstructor(TipoInstructor tipoInstructor) {
