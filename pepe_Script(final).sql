...
-- -----------------------------------------------------
-- Table `pepe_db`.`estapa_practica`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pepe_db`.`estapa_practica` (
...
CREATE TABLE IF NOT EXISTS `pepe_db`.`usuario` (
  ...
  CONSTRAINT `fk_usuario_estapa_practica1`
    ...
    REFERENCES `pepe_db`.`estapa_practica` (`id_etapa_practica`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `pepe_db`.`fase` (
  ...
  PRIMARY KEY (`id_fase`),
  INDEX `fk_fase_aspectos1_idx` (`id_aspectos` ASC),
  CONSTRAINT `fk_fase_aspectos1`
...
-- -----------------------------------------------------
-- Table `pepe_db`.`tipo_evaluacion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pepe_db`.`tipo_evaluacion` (
  `id_tipo_evaluacion` INT NOT NULL AUTO_INCREMENT,
  `nombre_tipo_evaluacion` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pepe_db`.`tecnica_didactica` (
  ...
  `id_instrumento_evaluacion` INT NOT NULL,
  PRIMARY KEY (`id_tecnica_didactica`),
  INDEX `fk_tecnica_didactica_instrumento_evaluacion1_idx` (`id_instrumento_evaluacion` ASC),
  CONSTRAINT `fk_tecnica_didactica_instrumento_evaluacion1`
    FOREIGN KEY (`id_instrumento_evaluacion`)
    REFERENCES `pepe_db`.`instrumento_evaluacion` (`id_instrumento_evaluacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `pepe_db`.`evidencia` (
  ...
  INDEX `fk_evidencia_tipo_evaluacion1_idx` (`id_tipo_evaluacion` ASC),
  INDEX `fk_evidencia_tecnica_didactica1_idx` (`id_tecnica_didactica` ASC),
  ...
  CONSTRAINT `fk_evidencia_tipo_evaluacion1`
    ...
    REFERENCES `pepe_db`.`tipo_evaluacion` (`id_tipo_evaluacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `pepe_db`.`descripcion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pepe_db`.`descripcion` (
  `id_descripcion` INT NOT NULL AUTO_INCREMENT,
  `nombre_descripcion` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pepe_db`.`variable` (
  ...
  INDEX `fk_variable_descripcion1_idx` (`id_descripcion` ASC),
  CONSTRAINT `fk_Variable_Revision1`
    FOREIGN KEY (`id_revision`)
    REFERENCES `pepe_db`.`revision` (`id_revision`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_variable_descripcion1`
    FOREIGN KEY (`id_descripcion`)
    REFERENCES `pepe_db`.`descripcion` (`id_descripcion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `pepe_db`.`tipo_evaluacion_has_tecnica_didactica`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pepe_db`.`tipo_evaluacion_has_tecnica_didactica` (
  `id_tipo_evaluacion` INT NOT NULL,
  `id_tecnica_didactica` INT NOT NULL,
  PRIMARY KEY (`id_tipo_evaluacion`, `id_tecnica_didactica`),
  INDEX `fk_tipo_evaluacion_has_tecnica_didactica_tecnica_didactica1_idx` (`id_tecnica_didactica` ASC),
  INDEX `fk_tipo_evaluacion_has_tecnica_didactica_tipo_evaluacion1_idx` (`id_tipo_evaluacion` ASC),
...
-- -----------------------------------------------------
-- Table `pepe_db`.`revision_has_usuario1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pepe_db`.`revision_has_usuario1` (
  `id_revision` INT NOT NULL,
  `id_usuario` INT NOT NULL,
  PRIMARY KEY (`id_revision`, `id_usuario`),
  INDEX `fk_revision_has_usuario1_usuario1_idx` (`id_usuario` ASC),
  INDEX `fk_revision_has_usuario1_revision1_idx` (`id_revision` ASC),
  CONSTRAINT `fk_revision_has_usuario1_revision1`
    FOREIGN KEY (`id_revision`)
    REFERENCES `pepe_db`.`revision` (`id_revision`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_revision_has_usuario1_usuario1`
    FOREIGN KEY (`id_usuario`)
    REFERENCES `pepe_db`.`usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `pepe_db`.`seguimiento` (
  ...
  INDEX `fk_seguimiento_fase1_idx` (`fase_id_fase` ASC),
  INDEX `fk_seguimiento_ficha1_idx` (`ficha_id_ficha` ASC),
...
-- -----------------------------------------------------
-- Table `pepe_db`.`actividad_aprendizaje_copy1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pepe_db`.`actividad_aprendizaje_copy1` (
  `id_actividad_aprendizaje` INT NOT NULL AUTO_INCREMENT,
  `nombre_actividad_aprendizaje` TEXT NOT NULL,
  `duracion_actividad_aprendizaje` INT NOT NULL,
  `observaciones` TEXT NOT NULL,
  ...
  INDEX `fk_actividad_aprendizaje_tipo_actividad_aprendizaje1_idx` (`id_tipo_actividad_aprendizaje` ASC),
  INDEX `fk_actividad_aprendizaje_actividad_proyecto1_idx` (`id_actividad` ASC),
  CONSTRAINT `fk_Actividad_Aprendizaje_Tipo_Actividad_Aprendizaje10`
    FOREIGN KEY (`id_tipo_actividad_aprendizaje`)
    REFERENCES `pepe_db`.`tipo_actividad_aprendizaje` (`id_tipo_actividad_aprendizaje`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_actividad_aprendizaje_actividad_proyecto10`
    FOREIGN KEY (`id_actividad`)
    REFERENCES `pepe_db`.`actividad` (`id_actividad`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Data for table `pepe_db`.`estapa_practica`
-- -----------------------------------------------------
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`estapa_practica` (`id_etapa_practica`, `nombre_empresa`, `representante`, `telefono`, `Correo`, `tipo_practica`) VALUES (1, 'sony', 'luis', '12434', 'junior@hot.com', 'pasantia');
INSERT INTO `pepe_db`.`estapa_practica` (`id_etapa_practica`, `nombre_empresa`, `representante`, `telefono`, `Correo`, `tipo_practica`) VALUES (2, 'hp', 'fredy', '1234', 'fredy@gmail.com', 'monitorias');
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`aspectos` (`id_aspectos`, `descripcion`, `cumple`) VALUES (1, 'xxxxx', 1);
INSERT INTO `pepe_db`.`aspectos` (`id_aspectos`, `descripcion`, `cumple`) VALUES (2, 'xxxxx', 0);
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`fase` (`id_fase`, `fase`, `id_aspectos`) VALUES (1, 'analisis', 1);
INSERT INTO `pepe_db`.`fase` (`id_fase`, `fase`, `id_aspectos`) VALUES (2, 'planeacion', 1);
INSERT INTO `pepe_db`.`fase` (`id_fase`, `fase`, `id_aspectos`) VALUES (3, 'ejecucion', 2);
INSERT INTO `pepe_db`.`fase` (`id_fase`, `fase`, `id_aspectos`) VALUES (4, 'evaluacion', 2);
...
INSERT INTO `pepe_db`.`actividad` (`id_actividad`, `nombre_actividad_proyecto`, `duracion`, `id_proyecto`, `id_fase`) VALUES (2, 'on respecto a los resultados', 121, 2223, 1);
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`tipo_evidencia` (`id_tipo_evidencia`, `tipo_evidencia`) VALUES (1, 'Digital');
INSERT INTO `pepe_db`.`tipo_evidencia` (`id_tipo_evidencia`, `tipo_evidencia`) VALUES (2, 'Fisica');
...
-- -----------------------------------------------------
-- Data for table `pepe_db`.`tipo_evaluacion`
-- -----------------------------------------------------
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`tipo_evaluacion` (`id_tipo_evaluacion`, `nombre_tipo_evaluacion`) VALUES (1, 'Conocimiento');
INSERT INTO `pepe_db`.`tipo_evaluacion` (`id_tipo_evaluacion`, `nombre_tipo_evaluacion`) VALUES (2, 'Desempeño');
INSERT INTO `pepe_db`.`tipo_evaluacion` (`id_tipo_evaluacion`, `nombre_tipo_evaluacion`) VALUES (3, 'Producto');
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`instrumento_evaluacion` (`id_instrumento_evaluacion`, `nombre_instrumento_evaluacion`) VALUES (1, 'Cuestionario');
INSERT INTO `pepe_db`.`instrumento_evaluacion` (`id_instrumento_evaluacion`, `nombre_instrumento_evaluacion`) VALUES (2, 'Guia de Entrevista');
INSERT INTO `pepe_db`.`instrumento_evaluacion` (`id_instrumento_evaluacion`, `nombre_instrumento_evaluacion`) VALUES (3, 'Lista de Chequeo');
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`tecnica_didactica` (`id_tecnica_didactica`, `tecnica_didactica`, `id_instrumento_evaluacion`) VALUES (1, 'Caso de Estudio', 1);
INSERT INTO `pepe_db`.`tecnica_didactica` (`id_tecnica_didactica`, `tecnica_didactica`, `id_instrumento_evaluacion`) VALUES (2, 'Formulación de Pregunta', 1);
INSERT INTO `pepe_db`.`tecnica_didactica` (`id_tecnica_didactica`, `tecnica_didactica`, `id_instrumento_evaluacion`) VALUES (3, 'Entrevista', 2);
INSERT INTO `pepe_db`.`tecnica_didactica` (`id_tecnica_didactica`, `tecnica_didactica`, `id_instrumento_evaluacion`) VALUES (4, 'Observación Directa', 3);
INSERT INTO `pepe_db`.`tecnica_didactica` (`id_tecnica_didactica`, `tecnica_didactica`, `id_instrumento_evaluacion`) VALUES (5, 'Simulación de Situaciones', 3);
INSERT INTO `pepe_db`.`tecnica_didactica` (`id_tecnica_didactica`, `tecnica_didactica`, `id_instrumento_evaluacion`) VALUES (6, 'Valoración de Producto', 3);
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`evidencia` (`id_evidencia`, `id_tipo_evidencia`, `nombre_evidencia`, `id_actividad_aprendizaje`, `descripcion_evidencia`, `observacion_evidencia`, `id_tipo_evaluacion`, `id_tecnica_didactica`) VALUES (1, 1, 'entrega de algoritmos', 1, 'xxxx', 'xxxx', 1, 1);
INSERT INTO `pepe_db`.`evidencia` (`id_evidencia`, `id_tipo_evidencia`, `nombre_evidencia`, `id_actividad_aprendizaje`, `descripcion_evidencia`, `observacion_evidencia`, `id_tipo_evaluacion`, `id_tecnica_didactica`) VALUES (2, 2, 'ninguna', 2, 'xxxxx', 'xxxxx', 1, 1);
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`revision` (`id_revision`, `concepto`, `id_proyecto`, `fecha_revision`) VALUES (1, 'xxxx', 2222, '2000-12-12');
INSERT INTO `pepe_db`.`revision` (`id_revision`, `concepto`, `id_proyecto`, `fecha_revision`) VALUES (2, 'xxxx', 2223, '2000-12-12');

COMMIT;


-- -----------------------------------------------------
-- Data for table `pepe_db`.`descripcion`
-- -----------------------------------------------------
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`descripcion` (`id_descripcion`, `nombre_descripcion`) VALUES (1, 'gfghfgjfjhh');
INSERT INTO `pepe_db`.`descripcion` (`id_descripcion`, `nombre_descripcion`) VALUES (2, 'gghchxfxhggv');
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`variable` (`id_variable`, `descripcion`, `cumple`, `observacion`, `id_revision`, `id_descripcion`) VALUES (1, 'xxxxx', 1, 'ninguna', 1, 1);
INSERT INTO `pepe_db`.`variable` (`id_variable`, `descripcion`, `cumple`, `observacion`, `id_revision`, `id_descripcion`) VALUES (2, 'xxxxx', 0, 'ninguna', 2, 2);
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`recurso` (`id_recurso`, `nombre`, `cantidad`, `valor_unitario`, `codigo_orions`, `id_fuente_recursos`, `id_tipo_recurso`, `id_unidad_medida`, `id_rubro_presupuestal`) VALUES (1, 'fff', 4, 12000, NULL, 1, 1, 1, NULL);
INSERT INTO `pepe_db`.`recurso` (`id_recurso`, `nombre`, `cantidad`, `valor_unitario`, `codigo_orions`, `id_fuente_recursos`, `id_tipo_recurso`, `id_unidad_medida`, `id_rubro_presupuestal`) VALUES (2, 'dddd', 5, 1200, NULL, 1, 1, 1, NULL);
...
-- -----------------------------------------------------
-- Data for table `pepe_db`.`tipo_evaluacion_has_tecnica_didactica`
-- -----------------------------------------------------
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`tipo_evaluacion_has_tecnica_didactica` (`id_tipo_evaluacion`, `id_tecnica_didactica`) VALUES (1, 1);
INSERT INTO `pepe_db`.`tipo_evaluacion_has_tecnica_didactica` (`id_tipo_evaluacion`, `id_tecnica_didactica`) VALUES (1, 2);
INSERT INTO `pepe_db`.`tipo_evaluacion_has_tecnica_didactica` (`id_tipo_evaluacion`, `id_tecnica_didactica`) VALUES (1, 3);
INSERT INTO `pepe_db`.`tipo_evaluacion_has_tecnica_didactica` (`id_tipo_evaluacion`, `id_tecnica_didactica`) VALUES (2, 4);
INSERT INTO `pepe_db`.`tipo_evaluacion_has_tecnica_didactica` (`id_tipo_evaluacion`, `id_tecnica_didactica`) VALUES (2, 5);
INSERT INTO `pepe_db`.`tipo_evaluacion_has_tecnica_didactica` (`id_tipo_evaluacion`, `id_tecnica_didactica`) VALUES (2, 2);
INSERT INTO `pepe_db`.`tipo_evaluacion_has_tecnica_didactica` (`id_tipo_evaluacion`, `id_tecnica_didactica`) VALUES (3, 4);
INSERT INTO `pepe_db`.`tipo_evaluacion_has_tecnica_didactica` (`id_tipo_evaluacion`, `id_tecnica_didactica`) VALUES (3, 6);

COMMIT;


-- -----------------------------------------------------
-- Data for table `pepe_db`.`revision_has_usuario1`
-- -----------------------------------------------------
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`revision_has_usuario1` (`id_revision`, `id_usuario`) VALUES (1, 1);
...
START TRANSACTION;
USE `pepe_db`;
INSERT INTO `pepe_db`.`seguimiento` (`id_seguimiento`, `observaciones`, `fase_id_fase`, `ficha_id_ficha`) VALUES (1, NULL, 1, 1);
INSERT INTO `pepe_db`.`seguimiento` (`id_seguimiento`, `observaciones`, `fase_id_fase`, `ficha_id_ficha`) VALUES (2, NULL, 1, 1);
